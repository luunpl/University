...
/* Ne pas modifier l'arbre si la valeur est déjà présente. */
/* conseil : utiliser une fonction auxiliaire récursive qui renvoie l'arbre 
 * potentiellement modifié par valeur de retour */
/*
 * /!\ pour la fonction 'inserer_abr' l'argument est un pointeur vers un arbre 
 * (donc un pointeur de pointeur de nœud)
 */
