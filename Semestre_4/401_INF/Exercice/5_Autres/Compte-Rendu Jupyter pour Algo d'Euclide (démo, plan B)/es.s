...
@ EcrCar :
@    ecriture d'un caractre dont la valeur est dans r1
EcrCar:
   mov ip, sp
   stmfd sp!, {r0, r1, r2, r3, fp, ip, lr, pc}
	sub     fp, ip, #4
...
@ EcrHexa32 :
@    ecriture d'un mot de 32 bits en hexadcimal
...
EcrHexa32:
   ...
   stmfd sp!, {r0, r1, r2, r3, fp, ip, lr, pc}
	...
	@ EcrHexa16 :
@    ecriture d'un demi mot de 16 bits en hexadcimal
...
@ EcrHexa8 :
@    ecriture d'un octet en hexadcimal
