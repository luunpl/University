...
#--------question 1------------
apnee <- read.table("~/Personal/University/Semestre_4/401_STA/TP/Donnees/apnee.csv")
head(apnee)
#101 observations d'une seule variable ==> separateur de champs incorrect
apnee  <- read.table("~/Personal/University/Semestre_4/401_STA/TP/Donnees/apnee.csv",sep=",")
...
apnee <- read.table("~/Personal/University/Semestre_4/401_STA/TP/Donnees/apnee.csv",sep=",",header=T)
...
head(read.csv("~/Personal/University/Semestre_4/401_STA/TP/Donnees/cardiaque.csv"))
...
#--------question 3------------
her <- read.table("~/Personal/University/Semestre_4/401_STA/TP/Donnees/her.txt",sep="\t",dec=".",header=T)
