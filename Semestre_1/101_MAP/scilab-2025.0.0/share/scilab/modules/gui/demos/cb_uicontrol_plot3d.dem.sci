...
function uicontrol_plot3d()
    ...
    jetcolor = uicontrol(frame_colormap, ...
        "tag", "jet", ...
        "backgroundcolor", [1 1 1], ...
        "style", "radiobutton", ...
        "string", "Jet Colormap", ...
...
function update_colormap()
    ...
    if get(gcbo, "tag") == "jet" then
        my_figure.color_map = jet(128);
    elseif get(gcbo, "tag") == "hot" then
        my_figure.color_map = hot(128);
    elseif get(gcbo, "tag") == "gray" then
        my_figure.color_map = gray(128);
    end
