...
public class LignePolygonale {
    ...
    // Constantes
    // ------------------------------------------------
    public static final int NB_MAX_SOMMETS = 10;

    // attributs

    private Point[] sommets; // tableau permettant de stoker les sommets de la ligne
    private int nbSommets; // nombre de sommets de la ligne (2 <= nbSommets <= NB_MAX_SOMMETS)
    ...
    public LignePolygonale(double x1, double y1, double x2, double y2)
        ...
        sommets = new Point[NB_MAX_SOMMETS];
     ...
     *         point origine est confondu avec le point extrémité)
     */
    public LignePolygonale(Point p1, Point p2) throws IllegalOperationException {
    ...
    public Point getOrigine() {
        ...
        // et non pas le sommet origine. En effet la relation entre la classe LignePolygonale
    ...
    public LignePolygonale ajouterSommet(double x, double y) throws IllegalOperationException {
        ...
        if (this.nbSommets == NB_MAX_SOMMETS) {
            throw new IllegalOperationException(
                    "Nombre de somemts maximum déjà atteint, impossible d'ajouter un nouveau sommet");
        }
